...
const AthleteComplete1 = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        ...
        <View>
          <Text style={styles.textName}>Harry Potter</Text>
          <Text style={[styles.spacingBetweenText, styles.textInfo]}>
            
          </Text>
          <Text style={styles.textInfo}>Northeastern University</Text>
        </View>
      </View>
...
export default AthleteComplete1;
